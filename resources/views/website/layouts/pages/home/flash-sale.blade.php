<section class="product__section section--padding pt-0">
    <div class="container-fluid">
        <div class="section__heading text-center mb-50">
            <h2 class="section__heading--maintitle">Flash salling Products</h2>
        </div>
        <div class="product__section--inner product__swiper--activation swiper">
            <div class="swiper-wrapper">

                @foreach ($flashSallingProducts as $key => $product)
                            ...
                            <div class="product__items--content">
                                ...
                                <div class="product__items--price">
                                    ...
                                    @if ($product->discount_value)
                                        ...
                                        <span class="old__price">৳{{ number_format($product->base_price, 2) }}</span>
                                    @endif
                                </div>
