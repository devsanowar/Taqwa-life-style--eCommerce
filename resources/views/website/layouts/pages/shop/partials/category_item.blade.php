...
@if ($level === 0)
    <li class="widget__categories--menu__list">
        ...
        <a class="widget__categories--menu__label d-flex align-items-center js-category-filter"
           href="{{ route('shop.page', ['category' => $category->slug]) }}"
           data-category="{{ $category->slug }}">
            ...
            @if ($hasChildren)
                <span class="js-cat-toggle widget__categories--menu__arrowdown--icon" role="button" aria-label="Toggle sub categories">
